...
export class View {
    ...
    renderCategory(categoryID, categoryName, products) {
    ...
    getCardsProductsTemplate(products) {
        let response = '';
    ...
    getMenuProductsTemplate(products) {
        let response = '';
        products.forEach(product => {
            response +=
